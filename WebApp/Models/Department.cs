...
namespace WebApp.Models
{
    public class Department
    {
        ...
        [MaxLength(30, ErrorMessage ="the department name will have no more than 30 characters")]
        /*the department name will have the max length of 30 characters*/
        [MinLength(3, ErrorMessage ="the department name will at least 5 character")]
        /*the department name should have the minimum length of 3 characters*/
